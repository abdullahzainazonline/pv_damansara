...
const sections = [
  ...
  { id: "virtual-tour", label: "360 View" },
    ...
    <div className="fixed right-5 top-1/2 -translate-y-1/2 z-[80] hidden xl:flex flex-col items-center gap-3">
      ...
      {sections.map(({ id, label }) => (
        <a
          ...
          aria-label={label}
        >
          <div className={`w-2 h-2 rounded-full transition-all duration-300 ${active === id ? "bg-gold scale-125 shadow-[0_0_8px_rgba(196,162,101,0.4)]" : "bg-glass-border hover:bg-gold/40"
            }`} />
