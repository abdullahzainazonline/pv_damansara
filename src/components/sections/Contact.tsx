...
<<<<<<< HEAD
    ...
    { src: "/pdh/(feb_2026)_pdh_rc_ro_p16_img1.jpeg", label: "Rooftop Sky Garden" },
    ...
    { src: "/pdh/(feb_2026)_pdh_rc_ro_p6_img1.jpeg", label: "Master Bedroom" },
    { src: "/pdh/(feb_2026)_pdh_rc_ro_p17_img1.jpeg", label: "Aerial Pavilion View" },
    { src: "/pdh/(feb_2026)_pdh_rc_ro_p18_img1.jpeg", label: "Crown Penthouse" },
];
                        ...
                        <div className="lg:col-span-12 flex flex-col items-center text-center">
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-12 py-8 border-y border-white/5 w-full">
                                <a href="tel:+60122705608" className="flex items-center gap-4 group">
                                    ...
                                    <span className="text-[15px] font-sans font-semibold text-white/70 group-hover:text-whitetransition-colors">+60 12-270 5608</span>
                                </a>
